...
import 'package:mlmdiary/home/addblog/controller/add_blog_controller.dart';
...
class AddBlog extends StatefulWidget {
  ...
  @override
  State<AddBlog> createState() => _ManageBlogPlusIconState();
}

class _ManageBlogPlusIconState extends State<AddBlog> {
  final AddBlogController controller = Get.put(AddBlogController());
                    ...
                    child: CustomButton(
                      ...
                      onTap: () {
                        if (controller.selectedCountCategory > 0) {
                          ...
                          showToasterrorborder(
                              'PlPlease select at least one field.', context);
                        }
                      },
                      isLoading: controller.isLoading,
                    ),
