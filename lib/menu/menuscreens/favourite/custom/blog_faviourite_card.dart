...
class BlogFaviouriteCard extends StatefulWidget {
  ...
  @override
  State<BlogFaviouriteCard> createState() => _FavouritrCardState();
}

class _FavouritrCardState extends State<BlogFaviouriteCard>
              ...
              children: [
                ...
                Row(
                  children: [
                    GestureDetector(
                      onTap: () =>
                          showFullScreenDialogBlog(context, widget.bookmarkId),
                      child: SizedBox(
                        height: size.height * 0.028,
                        width: size.height * 0.028,
