...
class _CommentDialogState extends State<CommentDialogNews> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  if (isReply) {
                    await controller.editComment(widget.newsId, data.id ?? 0,
                        editedComment, 'news', context);
                  } else {
                    await controller.editComment(widget.newsId, data.id ?? 0,
                        editedComment, 'news', context);
                  }
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              await controller.deleteComment(widget.newsId, commentId, context);
              await _refreshData();
            },
  ...
  // Example usage:
  void _showEditCommentDialog(GetCommentNewsData comment) {
    _showEditDialog(comment, false);
  }

  void _showEditReplyDialog(GetCommentNewsDataCommentsReplays reply) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            await controller.addReplyNewsComment(
                                widget.newsId, commentId, context);
                            controller.commment.value.clear();
                            Get.back();
                          },
                          child: Container(
