...
class NewsBottomsheetContent extends StatefulWidget {
  const NewsBottomsheetContent({super.key});

  @override
  State<NewsBottomsheetContent> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<NewsBottomsheetContent> {
