...
class QuestionUserCard extends StatefulWidget {
  ...
  @override
  State<QuestionUserCard> createState() => _FavouritrCardState();
}

class _FavouritrCardState extends State<QuestionUserCard> {
